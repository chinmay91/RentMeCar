...
import com.rentmecar.rest.security.angularjs.model.Error;
import com.rentmecar.rest.security.angularjs.model.Response;
...
public class SecurityUtils {
	...
	public static void sendError(HttpServletResponse response, Exception exception, int status, String message)
		...
		System.out.println("This was handled!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
